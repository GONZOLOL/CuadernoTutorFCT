...
CREATE TABLE TUTOR_LABORAL (
    ...
    Nombre VARCHAR(50) NOT NULL,
    Apellidos VARCHAR(50) NOT NULL,
    Denominacion_centro VARCHAR(100) NOT NULL,
    CIF_EMPRESA VARCHAR(10) NOT NULL,
    FOREIGN KEY (Denominacion_centro) REFERENCES CENTRO_TRABAJO(Denominacion),
    FOREIGN KEY (CIF_EMPRESA) REFERENCES EMPRESA(CIF),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
);
...
CREATE TABLE EVALUACIÓN_QUINCENAL (
    ID INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
    Id_cuaderno INT NOT NULL,
    FOREIGN KEY (Id_cuaderno) REFERENCES CUADERNO_TUTOR(Id_cuaderno),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE CAPACIDADES_TÉCNICAS (
    ID INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
    opcion_1 INT NOT NULL,
    opcion_2 INT NOT NULL,
    opcion_3 INT NOT NULL,
    opcion_4 INT NOT NULL,
    opcion_5 INT NOT NULL,
    ID_EVAU_QUINCENAL INT NOT NULL,
    FOREIGN KEY (ID_EVAU_QUINCENAL) REFERENCES EVALUACIÓN_QUINCENAL(ID),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
);

CREATE TABLE CAPACIDADES_ORGANIZATIVAS (
    ID INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
    opcion_1 INT NOT NULL,
    opcion_2 INT NOT NULL,
    opcion_3 INT NOT NULL,
...
CREATE TABLE CAPACIDADES_RELACIONALES (
    ID INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
    OPCION_1 INT NOT NULL,
    OPCION_2 INT NOT NULL,
    OPCION_3 INT NOT NULL,
...
CREATE TABLE CAPACIDADES_RESPUESTA (
    ID INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
    OPCION_1 INT NOT NULL,
    OPCION_2 INT NOT NULL,
    OPCION_3 INT NOT NULL,
...
CREATE TABLE VISITA (
    ...
    Observaciones VARCHAR(100),
    Núm_visitas_previstas INT NOT NULL,
    Id_cuaderno INT NOT NULL,
    FOREIGN KEY (Id_cuaderno) REFERENCES CUADERNO_TUTOR(Id_cuaderno),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
