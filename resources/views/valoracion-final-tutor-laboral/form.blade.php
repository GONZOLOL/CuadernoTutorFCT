<div class="box box-info padding-1">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('Alumno') }}
            {{ Form::select('dni_alumno', $alumnos, $valoracionFinalTutorLaboral->dni_alumno, ['class' => 'form-control w-25' . ($errors->has('dni_alumno') ? ' is-invalid' : ''), 'placeholder' => 'Selecciona un alumno']) }}
