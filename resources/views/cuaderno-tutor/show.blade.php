        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary mb-3 py-3 border-top border-white">
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              ...
              <a href="{{ route('generar-pdf', ['idCuaderno' => $cuadernoTutor->Id_cuaderno]) }}"
                class="btn btn-success d-flex justify-content-center align-items-center gap-1 ms-auto me-1"
                style="width: 180px; background-color: #17a2b8; border-color: #17a2b8;">
                Generar PDF
              </a>
            </div>
          </div>
                  ...
                  <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                      ...
                      <li class="list-group-item">
                        ...
                        <span class="float-right">{{ $cuadernoTutor->ciclo_formativo_curso_actual }}</span>
                      </li>
                    </ul>
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        <div class="d-flex flex-column my-2">
                          ...
                          <span class="custom-input">
                            <span class="detail-primary">{{ $cuadernoTutor->empresa->CIF }}</span>
                          </span>
                        </div>
                        <div class="d-flex flex-column my-2">
                          <span class="detail-label">Domicilio social</span>
                          <span class="custom-input">
                            <span class="detail-primary">{{ $cuadernoTutor->empresa->Domicilio_social }}</span>
                          </span>
                        </div>
                        <div class="d-flex flex-column my-2">
                          <span class="detail-label">Poblacion</span>
                          <span class="custom-input">
                            <span class="detail-primary">{{ $cuadernoTutor->empresa->Poblacion }}</span>
                          </span>
                        </div>
                        <div class="d-flex flex-column my-2">
                          <span class="detail-label">Código postal</span>
                          <span class="custom-input">
                            <span class="detail-primary">{{ $cuadernoTutor->empresa->Codigo_postal }}</span>
                          </span>
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="d-flex flex-column my-2">
                          ...
                          <span class="custom-input">
                            <span class="detail-primary">{{ $cuadernoTutor->empresa->Provincia }}</span>
                          </span>
                        </div>
                        <div class="d-flex flex-column my-2">
                          <span class="detail-label">Teléfono</span>
                          <span class="custom-input">
                            <span class="detail-primary">{{ $cuadernoTutor->empresa->Telefono }}</span>
                          </span>
                        </div>
                        <div class="d-flex flex-column my-2">
                          <span class="detail-label">Fax</span>
                          <span class="custom-input">
                            <span class="detail-primary">{{ $cuadernoTutor->empresa->Fax }}</span>
                          </span>
                        </div>
                        <div class="d-flex flex-column my-2">
                          <span class="detail-label">Movil</span>
                          <span class="custom-input">
                            <span class="detail-primary">{{ $cuadernoTutor->empresa->Movil }}</span>
                          </span>
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="d-flex flex-column my-2">
                          ...
                          <span class="custom-input">
                            <span class="detail-primary">{{ $cuadernoTutor->empresa->Titularidad }}</span>
                          </span>
                        </div>
                        <div class="d-flex flex-column my-2">
                          <span class="detail-label">Actividad</span>
                          <span class="custom-input">
                            <span class="detail-primary">{{ $cuadernoTutor->empresa->Actividad }}</span>
                          </span>
                        </div>
                        <div class="d-flex flex-column my-2">
                          <span class="detail-label">NIF representante</span>
                          <span class="custom-input">
                            <span class="detail-primary">{{ $cuadernoTutor->empresa->NIF_representante_legal }}</span>
                          </span>
                        </div>
                        <div class="d-flex flex-column my-2">
                      ...
                      <div class="col-md-3">
                        <div class="d-flex flex-column my-2">
                          ...
                          <span class="custom-input">
                            <span class="detail-primary">{{ $cuadernoTutor->empresa->Cargo_representante_legal }}</span>
                          </span>
                        </div>
                        <div class="d-flex flex-column my-2">
                          <span class="detail-label">Horario apertura</span>
                          <span class="custom-input">
                            <span class="detail-primary">{{ $cuadernoTutor->empresa->Horario_apertura }}</span>
                          </span>
                        </div>
                        <div class="d-flex flex-column my-2">
                          <span class="detail-label">Horario cierre</span>
                          <span class="custom-input">
                            <span class="detail-primary">{{ $cuadernoTutor->empresa->Horario_cierre }}</span>
                          </span>
                        </div>
                        <div class="d-flex flex-column my-2">
                          <span class="detail-label">Observaciones</span>
                          <span class="custom-input">
                            <span class="detail-primary">{{ $cuadernoTutor->empresa->Observaciones }}</span>
                          </span>
                        </div>
                      </div>
                    </div>
