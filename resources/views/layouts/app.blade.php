    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark bg-primary shadow-md" style="height:60px">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" style="margin-left:150px; margin-top:21px"
                    ...
                    <ul class="nav nav-tabs me-auto">
                        ...
                        <div class="d-flex">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle rounded px-3 text-white text-white" href="#"
                                    id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Alumnos
                                </a>
                                <ul class="dropdown-menu " aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item" href="{{ route('alumno.index') }}">Listado
                                            de
                                            alumnos</a>
                                    </li>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle rounded px-3 text-white" href="#" id="navbarDropdown"
                                    role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Empresas
                                </a>
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item" href="{{ route('empresa.index') }}">Listado de
                                            empresas</a>
                                    </li>
                                    ...
                                    <li><a class="dropdown-item" href="{{ route('centro-trabajo.index') }}">Listado
